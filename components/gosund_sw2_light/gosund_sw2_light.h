...
namespace esphome {
namespace gosund_sw2_light {

static const char *const TAG = "gosund_sw2_light";
...
light::LightTraits GosundSW2Light::get_traits()
{
...
void GosundSW2Light::write_state(light::LightState *state)
{
  ...
  if (indicator) indicator->set_state(enabled_target);
